  ...
  datasets: [
    {
      ...
      data: labels.map(() =>
        faker.datatype.number({ min: 5000000, max: 12000000 })
      ),
    ...
    },
    {
      ...
      data: labels.map(() =>
        faker.datatype.number({ min: 100000000, max: 246000000 })
      ),
  ...
  return (
    <div className="h-full">
      <Card
        ...
        type="inner"
        title={
          <p className="font-bold text-gray-400">Biểu đồ so sánh doanh thu</p>
        }
